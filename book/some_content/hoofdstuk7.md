...
In dit hoofdstuk behandelen we de [while loop](while.ipynb).  
Verder ga je het spel [Steen-Papier-Schaar](SPS_while.ipynb) dat je eerder hebt gemaakt, zo aanpassen dat je het een aantal keren speelt.
Tot slot maak je nog een [aantal afsluitende opdrachten](oefeningen_while.ipynb) die je weer in teams inlevert.  
